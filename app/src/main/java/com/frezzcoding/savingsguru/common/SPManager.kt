...
class SPManager(val context : Context, private val sharedPreferences: SharedPreferences) {
    ...
    companion object{
        ...
        const val NOTIFICATION_SWITCHED_ON = "android.content.SharedPreferences.notificationSwitchedOn"
    }
    ...
    fun setNotificationSwitchState(switched : Boolean) = saveBoolean(NOTIFICATION_SWITCHED_ON, switched)
